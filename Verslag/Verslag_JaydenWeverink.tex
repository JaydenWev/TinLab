...
\vskip1cm
heeft in zijn geschiedenis 
 He summarized this program in two basic assertions. 
The first states that "all geometric facts are expressed by the vanishing of invariants", 
and the second states that "all invariants are invariants of tensors"
